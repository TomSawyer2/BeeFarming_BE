package com.bf.common.service.impl;
...
public class RedisServiceImpl implements RedisService {
     ...
     */
    private static final String KEY_PREFIX_KEY = "bf:key";
    private static final String KEY_PREFIX_SET = "bf:set";
    private static final String KEY_PREFIX_LIST = "bf:list";
    ...
    public Long getExpireTime(String key) {
        try {
            ...
            log.error("获取缓存过期时间失败 key:[{}] 失败原因 [{}]", key, e);
        }
        return null;
    }
